...
const viewDepartmentBudget = async () => {
    let department = await getTable('department')
}
    ...
    switch (answers.action) {
        ...
        case 'employeeManager':
            return await questions.inquirer
                ...
                .then(async (employee) => {
                    return await viewEmployeeByManager(employee.manager_id);
                });
        case 'employeeDepartment':
            return await questions.inquirer
                .prompt(questions.viewEmployeeDepartment)
                .then(async (employee) => {
                    return await viewEmployeeByDepartment(employee.department_id);
                });

        case 'budget':
            return await viewDepartmentBudget(answers.department_id);
        case 'goBack':
